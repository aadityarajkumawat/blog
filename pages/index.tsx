          ...
          {!local.viewMore && (
            <div>
              <p className="text-justify">
                ...
                technologies and make videos to share my understanding of
                things, a little over 4 years of programming and I have learnt
                that the best way to understand things is building mental models
                and applying them.
              </p>
              <br />
            </div>
